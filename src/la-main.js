...
module.exports = {createParticipant, createSession, addClientToSocketDict, addHostToSocketDict, checkActiveSession, getClientSockets, getHostSocket, sendToHostSocket, removeFromSocketDict, endSession};
